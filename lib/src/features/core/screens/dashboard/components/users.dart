...
import 'package:pony_logistics/src/features/core/screens/dashboard/graph_screen.dart';
...
class Users extends StatelessWidget {
  const Users(this.height, {Key? key}) : super(key: key);
  final double height;
  ...
  double getHeight(BuildContext context) {
    if (height == 0.0) {
      return Responsive.isMobile(context) ? 405 : 540;
    }
    return height;
  }
